...
class CourseOutlineTool(Tool):
    """Tool for retrieving a full course outline from the catalog collection"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: its title, course link, and every lesson number and title. Use this for any question asking for a course outline, syllabus, or lesson list.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
